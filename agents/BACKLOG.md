...
| A-016 | P0 | Fix priority security findings | Review | [WP-016](./work-packages/WP-016-security-priority-fixes.md) | Approved in REVIEW-016 and integrated candidate REVIEW-017; merge tracked in PR #96; no deployment |
| A-017 | P0 | Integrate synchronous FFI for Meshrooms | Review | [WP-017](./work-packages/WP-017-meshrooms-sync-integration.md) | Approved in REVIEW-017; exact native artifact qualified with Meshrooms; merge tracked in PR #96 |
