...
| A-014 | P1 | Prepare repository for public release | Review | [WP-014](./work-packages/WP-014-public-release-preparation.md) | MIT and security policy applied; owner approved existing history; local validation and existing remote CI rerun passed; final publication commit still needs hosted checks |
